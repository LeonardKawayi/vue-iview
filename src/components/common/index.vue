    ...
    <Row type="flex">
      <i-col :span="spanLeft" class="layout-menu-left">
        <Menu :active-name="setActive" theme="dark" width="auto" @on-select="routeTo">
          ...
          <Menu-item name="select">
            <Icon type="ios-color-wand" :size="iconSize"></Icon>
            <span class="layout-text">选择器</span>
          </Menu-item>
          <Menu-item name="date-picker">
            <Icon type="ios-keypad-outline" :size="iconSize"></Icon>
            <span class="layout-text">日期选择器</span>
          </Menu-item>
          <Menu-item name="alert">
            <Icon type="ios-crop" :size="iconSize"></Icon>
            <span class="layout-text">警告提示</span>
          </Menu-item>
          <Menu-item name="message">
          <Icon type="ios-grid-view-outline" :size="iconSize"></Icon>
          <span class="layout-text">全局提示</span>
        </Menu-item>
          <Menu-item name="tag">
            <Icon type="ios-timer-outline" :size="iconSize"></Icon>
            <span class="layout-text">Tag标签</span>
          </Menu-item>
          <Menu-item name="radio">
            <Icon type="ionic" :size="iconSize"></Icon>
            <span class="layout-text">单选钮</span>
          </Menu-item>
      ...
      <i-col :span="spanRight">
        ...
        <div class="avater">
          ...
          <span class="avater-name">您好，张振坤</span>
        </div>
  ...
  export default {
    ...
    data() {
      return {
        spanLeft: 5,
        spanRight: 19,
        page: ['about','form','table', 'select', 'date-picker','alert', 'message', 'tag', 'radio', 'markdown-viewer', 'markdown-editor-1', 'markdown-editor-2','rtf','upload','echarts']
      }
    },
    computed: {
      iconSize() {
